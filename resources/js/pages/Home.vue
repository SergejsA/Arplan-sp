    ...
    <div class="container mx-auto p-0" v-if="render">
        <table id="tableLaiki" class="table">
            ...
            <tr>
                ...
                <td v-for="(ilgums, j) in ilgumiKopa" :key="'datakopa'+j" :class="{'brivdienacol6':j == 5, 'brivdienacol7':j == 6, 'sodienacol':j==currentDay-1}" class="beigas" style="text-align:center;">
                    <b>{{ ilgums }}</b>
                </td>
            </tr>
        </table>
